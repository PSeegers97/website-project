...
class BlackInDarkIn extends React.Component<Props, any> {
        ...
        if (e.target.childNodes[0].nodeName == '#text') {
            ...
            if (distanceMouseToLeftVerticalLine <= 100 || distanceMouseToLeftHorizontalLine <= 100 || distanceMouseToRightVerticalLine <= 100 || distanceMouseToBottomHorizontallLine <= 100 || distanceMouseToCenter <= 100) {
                if (e.target.childNodes[0].textContent === 'Black') {
                    this.setState({
                        weightFirstLine: 410,
                        weightSecondLine: 100,
                        weightFourthLine: 100,
                        weightThirdLine: 100
                    })
                }
    ...
    setFromEvent = (e: { clientX: number; clientY: number; }) => {
                    ...
                    <div className={styles.upperWrapper}>
                        ...
                        <div className={styles.secondLine}>
                            <div className={styles.firstIn} id={'firstIn'}
                                 style={{fontWeight: this.state.weightSecondLine}}>
                                in
                            </div>
                    ...
                    <div className={styles.lowerWrapper}>
                        ...
                        <div className={styles.fourthLine}>
                            ...
                            <div className={styles.secondIn} id={'secondIn'}
                                 style={{fontWeight: this.state.weightFourthLine}}>
                                in
                            </div>
                        </div>
                    </div>
