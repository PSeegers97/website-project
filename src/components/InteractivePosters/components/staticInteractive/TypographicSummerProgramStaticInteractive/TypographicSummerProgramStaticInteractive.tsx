...
import styles from './TypographicSummerProgramStaticInteractive.module.scss'
import { useLocation} from "react-router-dom";
import staticInteractive from "../TypographicSummerProgramStaticInteractive/TypographicSummerProgramStaticInteractive.module.scss";
import variableInteractive from "../../variableInteractive/TypographicSummerProgramVariableInteractive.module.scss";




function TypographicSummerProgramStaticInteractive() {
...
export default TypographicSummerProgramStaticInteractive;
